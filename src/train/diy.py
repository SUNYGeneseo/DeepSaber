...
print(f'Parent class of RectifiedAdam will be {KerasLegacyOptimizer}')
'''
keras/optimizer_v2/optimizer_v2.py is the only place where _set_hyper() is defined
'''
...
class RectifiedAdam(KerasLegacyOptimizer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # warden looking at the code for keras/src/optimizers/adam.py, it does things differently
        # it looks like learning_rate is non-keywork arg in keras/src/base_optimizer.py
        super().__init__(
...
def _minimize(strategy, tape, optimizer, loss, trainable_variables):
  ...
  aggregate_grads_outside_optimizer = (
      getattr(optimizer, '_HAS_AGGREGATE_GRAD', False) and  # pylint: disable=protected-access
      not isinstance(strategy.extended,
                     parameter_server_strategy.ParameterServerStrategyExtended))

  # warden: this will never fire with v3 keras
